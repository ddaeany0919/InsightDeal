        ...
        Column(Modifier.padding(16.dp)) {
            ...
            Row {
                OutlinedButton(
                    ...
                    Icon(Icons.Default.Refresh, null, tint = Color(0xFFFF9800), modifier = Modifier.size(18.dp))
                    Spacer(Modifier.width(2.dp))
                    Text("가격 체크", color = Color(0xFFFF9800))
                }
                ...
                OutlinedButton(
                    ...
                    Icon(Icons.Default.Delete, null, tint = Color(0xFFEA5353), modifier = Modifier.size(18.dp))
                    Spacer(Modifier.width(2.dp))
                    Text("삭제")
                }
            }
